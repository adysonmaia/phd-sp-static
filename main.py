...
def exp_2(args=[]):
    ...
    print("{} - {} - {}s".format("cloud", solution.get_active_nodes(), elapsed_time))
    ...
    # print("{} - {} - {}s".format("genetic 2", solution.get_active_nodes(), elapsed_time))

    start_time = time.time()
    solution = algo.genetic_2_2.solve_sp(config)
    elapsed_time = round(time.time() - start_time, 2)
    print("{} - {} - {}s".format("genetic 2.2", solution.get_qos_violation(), elapsed_time))

    # start_time = time.time()
    # solution = algo.genetic_3.solve_sp(config)
    # elapsed_time = round(time.time() - start_time, 2)
    # print("{} - {} - {}s".format("genetic 3", solution.get_qos_violation(), elapsed_time))

    # start_time = time.time()
    # solution = algo.genetic_mo.solve_sp(config)
    # elapsed_time = round(time.time() - start_time, 2)
    # print("{} - {} - {}s".format("nsga-ii", solution.get_qos_violation(), elapsed_time))
    # print("{} - {} - {}s".format("nsga-ii", solution.get_active_nodes(), elapsed_time))
