...
from alog.util.output import Output
...
class LP(SP_Solver):
    ...
    def solve(self):
        ...
        # Decision Variables
        dvar_place = mdl.continuous_var_matrix(nb_apps, nb_nodes, name="I", lb=0, ub=1)
        dvar_flow_exists = mdl.continuous_var_cube(nb_apps, nb_nodes, nb_nodes,
                                                   name="F", lb=0, ub=1)
